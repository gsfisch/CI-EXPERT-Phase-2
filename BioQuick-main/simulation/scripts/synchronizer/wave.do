...
add wave -noupdate -expand -group RECEIVER -label DATA_WIDTH /tb_hds_4_phase/dut/receiver/DATA_WIDTH
add wave -noupdate -expand -group RECEIVER -label i_clk /tb_hds_4_phase/dut/receiver/i_clk
add wave -noupdate -expand -group RECEIVER -label i_rst_n /tb_hds_4_phase/dut/receiver/i_rst_n
add wave -noupdate -expand -group RECEIVER -label i_req /tb_hds_4_phase/dut/receiver/i_req
add wave -noupdate -expand -group RECEIVER -label i_ready /tb_hds_4_phase/dut/receiver/i_ready
add wave -noupdate -expand -group RECEIVER -label i_data /tb_hds_4_phase/dut/receiver/i_data
add wave -noupdate -expand -group RECEIVER -label o_valid /tb_hds_4_phase/dut/receiver/o_valid
add wave -noupdate -expand -group RECEIVER -label o_ack /tb_hds_4_phase/dut/receiver/o_ack
add wave -noupdate -expand -group RECEIVER -label o_data /tb_hds_4_phase/dut/receiver/o_data
add wave -noupdate -expand -group RECEIVER -label ack_dst_d /tb_hds_4_phase/dut/receiver/ack_dst_d
add wave -noupdate -expand -group RECEIVER -label ack_dst_q /tb_hds_4_phase/dut/receiver/ack_dst_q
add wave -noupdate -expand -group RECEIVER -label req_synced /tb_hds_4_phase/dut/receiver/req_synced
add wave -noupdate -expand -group RECEIVER -label data_valid /tb_hds_4_phase/dut/receiver/data_valid
add wave -noupdate -expand -group RECEIVER -label output_ready /tb_hds_4_phase/dut/receiver/output_ready
add wave -noupdate -expand -group RECEIVER -label CS /tb_hds_4_phase/dut/receiver/CS
add wave -noupdate -expand -group RECEIVER -label NS /tb_hds_4_phase/dut/receiver/NS
add wave -noupdate -group {SPILL REGISTER} -label DATA_WIDTH /tb_hds_4_phase/dut/receiver/i_spill_register/DATA_WIDTH
add wave -noupdate -group {SPILL REGISTER} -label clk_i /tb_hds_4_phase/dut/receiver/i_spill_register/clk_i
add wave -noupdate -group {SPILL REGISTER} -label rst_ni /tb_hds_4_phase/dut/receiver/i_spill_register/rst_ni
add wave -noupdate -group {SPILL REGISTER} -label valid_i /tb_hds_4_phase/dut/receiver/i_spill_register/valid_i
add wave -noupdate -group {SPILL REGISTER} -label ready_o /tb_hds_4_phase/dut/receiver/i_spill_register/ready_o
add wave -noupdate -group {SPILL REGISTER} -label data_i /tb_hds_4_phase/dut/receiver/i_spill_register/data_i
add wave -noupdate -group {SPILL REGISTER} -label valid_o /tb_hds_4_phase/dut/receiver/i_spill_register/valid_o
add wave -noupdate -group {SPILL REGISTER} -label ready_i /tb_hds_4_phase/dut/receiver/i_spill_register/ready_i
add wave -noupdate -group {SPILL REGISTER} -label data_o /tb_hds_4_phase/dut/receiver/i_spill_register/data_o
...
update
WaveRestoreZoom {2402080 ps} {3250420 ps}
